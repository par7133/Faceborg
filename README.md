...
You can access your avatar by http://yourservername.xyz/<your_avatar>. Login with the password for the admin view. Drag-n-drop all your resources in the browser window. .txt files feed your blog, .png and .jpg your gallery, etc.<br>
